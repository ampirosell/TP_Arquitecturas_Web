...
CREATE TABLE IF NOT EXISTS estudiante_carrera (
    ...
    PRIMARY KEY (dni, carrera_id),
    FOREIGN KEY (dni) REFERENCES estudiante(dni) ON DELETE CASCADE,
...
INSERT INTO estudiante_carrera (dni, carrera_id, fecha_inscripcion, fecha_graduacion, graduado) VALUES 
(12345678, 1, '2020-03-01', NULL, FALSE),  -- Juan en Ingeniería en Sistemas
(87654321, 2, '2019-03-01', NULL, FALSE),  -- María en Medicina
(87654321, 4, '2020-03-01', NULL, FALSE),  -- María también en Psicología
(11223344, 1, '2021-03-01', NULL, FALSE),  -- Carlos en Ingeniería en Sistemas
(55667788, 3, '2018-03-01', '2023-12-15', TRUE),  -- Ana en Derecho (graduada)
(99887766, 5, '2019-03-01', NULL, FALSE),  -- Luis en Ingeniería Civil
(44332211, 6, '2020-03-01', NULL, FALSE);  -- Laura en Administración
