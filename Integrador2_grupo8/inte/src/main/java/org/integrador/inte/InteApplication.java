...
public class InteApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<EstudianteDTO> estudiantesMasculinos2 = estudianteService.obtenerEstudiantesPorGenero("Masculino");
            estudiantesMasculinos.addAll(estudiantesMasculinos2);
            ...
            List<EstudianteDTO> estudiantesFemeninos2 = estudianteService.obtenerEstudiantesPorGenero("Femenino");
            estudiantesFemeninos.addAll(estudiantesFemeninos2);
            ...
            if (!carreras.isEmpty() && !estudiantes.isEmpty()) {
                ...
                List<EstudianteDTO> estudiantesPorCarreraCiudad = estudianteService.obtenerEstudiantesPorCarreraCiudad(
                    carreras.get(0).getCarreraId().intValue(), ciudadBuscar);
